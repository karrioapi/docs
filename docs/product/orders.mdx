...
- **Direct label creation:** use Karrio's API or dashboard to create shipments and print labels for orders managed outside of Karrio
...
curl --request POST \
  ...
  --data '{
	...
	"billing_address": {
		"address_line1": "2259 Park Ct",
		"address_line2": "Apartment 5",
		"city": "Drayton Valley",
		"country_code": "CA",
		"email": "scgmoutboundops@xpo.com",
		"person_name": "Christopher Gorski",
