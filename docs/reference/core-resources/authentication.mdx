...
in places like yourkarrio .js JavaScript code, or in an Android or iPhone app.


## Obtaining your API keys

- Your Private API key is always available in the [Dashboard](api.karrio.io/developers/api):
...
```shell
curl --request POST \\
  --url http://api.karrio.io/api/token \\
