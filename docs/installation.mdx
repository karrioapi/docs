...
services:
  karrio:
    ...
    image: karrio.docker.scarf.sh/karrio/server:2022.8.15
  ...
  dashboard:
    ...
    image: karrio.docker.scarf.sh/karrio/dashboard:2022.8.15
    ports:
      - "3000:3000"
    environment:
...
The **karrio server** should be running at [http://localhost:5002](http://localhost:5002). <br/>
The **karrio dashboard** should be running at [http://localhost:3000](http://localhost:3000).
...
<img
  ...
  src="https://static.scarf.sh/a.png?x-pxid=e72dd847-dc7f-4f81-bce4-88eeb20d807f"
/>
