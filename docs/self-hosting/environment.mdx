...
The karrio server instance is configurable using the environment variables.
...
Some variables here are default Django variables.
This [Django Docs page](https://docs.djangoproject.com/en/3.2/ref/settings/) has more information about them.
...
- **`EMAIL_PAGE_DOMAIN`** | **default:** `https://app.karrio.io`
