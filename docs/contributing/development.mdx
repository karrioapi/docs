...
They are required for the following Python packages: `weasyprint and treepoem` use by the document generation module
for HTML to PDF document conversion and barcode generation.
:::
