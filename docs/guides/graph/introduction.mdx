...
# Purplship GraphQL API

purplship leverage a GraphQL API to expose access to shipping related
...
purplship exposes an interactive GraphQL editor under `/graphql/`, allowing
...
- To start integrating, [Checkout the GraphQL Reference](/docs/reference/graphql-api).
