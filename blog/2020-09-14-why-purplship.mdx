...
title: Why Purplship
authors: daniel
tags: [shipping, carrier, integration, purplship]
---
...
Purplship is an Open Source platform focused on making it easier for you to integrate
...
Saas are left with the pain of integrating with every single carrier. Purplship
...
service requirements and use cases. Purplship breaks down into simple modules, freight,
packages and document APIs to present specialized lightweight documentation that only
covers your needs.

#### Complete control with Open-core

Saas providers offer limited integrations of the carrier’s capabilities. Purplship
...
* [Report any issues on our public repository](https://github.com/purplhsip/purplship/issues)
